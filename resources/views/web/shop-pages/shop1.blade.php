            ...
            <div class="sub-manu collapse show multi-collapse" id="brands">
              ...
              <ul class="unorder-list">
                ...
                <li class="list-item">
                  ...
                  <a class="brands-btn list-item" href="{{url($item->manufacturers_url)}}" role="button"><i
                      class="fas fa-angle-right"></i>{{$item->manufacturer_name}}</a>
                  @else
                  <a class="brands-btn list-item" href="#" role="button"><i
                      class="fas fa-angle-right"></i>{{$item->manufacturer_name}}</a>
                  @endif
                </li>
                @endforeach
