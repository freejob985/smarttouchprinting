                  ...
                  <ul class="list">
                    <li>
                      ...
                      @if(!empty($result['commonContent']['setting'][52]->value))
                          <a style="display:none;" href="{{$result['commonContent']['setting'][52]->value}}" class="fab fa-twitter" target="_blank"></a>
                      @else
                          <a style="display:none;" href="#" class="fab fa-twitter"></a>
                      @endif</li>
                      <li>
                      @if(!empty($result['commonContent']['setting'][51]->value))
                          <a href="{{$result['commonContent']['setting'][51]->value}}"  target="_blank"><i class="fab fa-instagram"></i></a>
                      @else
                      ...
                      @if(!empty($result['commonContent']['setting'][53]->value))
                          <a  style="display:none;" href="{{$result['commonContent']['setting'][53]->value}}" class="fab fa-linkedin-in" target="_blank"></a>
                      @else
                          <a  style="display:none;" href="#" class="fab fa-linkedin-in"></a>
                      @endif
                      </li>
                  </ul>
